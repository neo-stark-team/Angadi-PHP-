   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      if($add_product_query){
         if($image_size > 2000000){
           ...
           window.open("http://localhost/Angadi/admin_products2.php?pname='.$name.'");</script>';
      ...
      <div class="inputBox">
            ...
            <select name="category" class="select">
               ...
               <option value="books">Books</option>
                ...
                <option value="kids">Kid's Fashion & Toys</option>
                <option value="art">Art & Stationery</option>
            </select>
         </div>
        </select>
         </div>
